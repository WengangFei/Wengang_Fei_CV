    ...
    <>
        ...
        <div className="font-mono grid grid-cols-2 gap-4 m-4">
            <div className="mr-6">
                ...
                <div>
                    <p className="font-bold mt-2">Interests:</p>
                    <div className="flex">
                        <img src='./ai.png' alt='ai' className="size-5"/>
                        <p className="text-xs italic text-sky-500 ml-5">
            ...
            <div>
                 <div>
                    ...
                    <p className="text-xs italic text-sky-500 ml-5 indent-5">
                        ...
                        created some class related projects, personal projects  as well,they 
