...
export default function header() {
  return (
    <div className="font-sans grid grid-cols-6 gap-4">
        <div className='col-span-4 '>
            <p className="text-4xl m-3">Wengang Fei</p>
            <p className="text-xl m-3">Computer Science</p>
            <p className="mt-3">Dedicated computer science student with a strong command 
        ...
        <div className="col-span-2 ml-10 mt-8 pl-10">
